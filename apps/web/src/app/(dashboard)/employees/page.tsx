...
const DEMO_EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    phone: '+971 50-0100007',
    department: { name: 'Engineering' },
    designation: { title: 'Frontend Specialist' },
    status: 'FULL_TIME',
  },
  {
    id: '8',
  ...
  },
  {
    ...
    phone: '+91 98-0100009',
    department: { name: 'Human Resources' },
    designation: { title: 'Talent Acquisition Partner' },
    status: 'FULL_TIME',
  },
  {
    id: '10',
    ...
    department: { name: 'Human Resources' },
    designation: { title: 'Chief People Officer' },
    status: 'FULL_TIME',
  },
  {
    id: '11',
    ...
    designation: { title: 'Finance Director' },
    status: 'FULL_TIME',
  },
  {
    id: '12',
    ...
    department: { name: 'Finance & Accounting' },
    designation: { title: 'Senior Payroll Specialist' },
    status: 'FULL_TIME',
  },
  {
    id: '13',
  ...
  },
  {
    ...
    phone: '+39 34-01000014',
    department: { name: 'Product & Design' },
    designation: { title: 'Senior Product Designer' },
    status: 'FULL_TIME',
  },
  {
    id: '15',
    ...
    phone: '+44 77-01000015',
    department: { name: 'Marketing & Growth' },
    designation: { title: 'Marketing Director' },
    status: 'FULL_TIME',
  },
  {
    id: '16',
    ...
    firstName: 'Victoria',
    lastName: 'Sterling',
    email: 'victoria.sterling@ems.local',
    phone: '+44 77-01000016',
    department: { name: 'Legal & Compliance' },
    designation: { title: 'Compliance Auditor' },
    status: 'FULL_TIME',
  },
  {
    id: '17',
    ...
    firstName: 'Michael',
    lastName: 'Chang',
    email: 'michael.chang@ems.local',
    phone: '+1 (555) 010-0017',
    department: { name: 'Customer Success' },
    designation: { title: 'Enterprise CS Manager' },
    status: 'PROBATION',
  },
  {
    id: '18',
    ...
    firstName: 'Rachel',
    lastName: 'Green',
    email: 'rachel.green@ems.local',
    phone: '+1 (555) 010-0018',
    department: { name: 'Quality Assurance & DevOps' },
    designation: { title: 'Lead QA Automation Engineer' },
    status: 'FULL_TIME',
  },
];
